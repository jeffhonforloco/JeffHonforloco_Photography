    ...
    <div className="hidden md:flex space-x-8 absolute left-1/2 transform -translate-x-1/2 items-center">
      ...
      <div className="ml-2">
        <button
          ...
          className="text-white hover:opacity-80 transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-photo-red focus:ring-offset-2 focus:ring-offset-black rounded"
